...
namespace exaStamp
{
  ...
  // === register factories ===  
  ONIKA_AUTORUN_INIT(coulombic_ewald_eshift)
  {  
    OperatorNodeFactory::instance()->register_factory( "coulombic_ewald_eshift" , make_simple_operator< EwaldPotentialEnergyShiftOperator > );
  }

...
namespace exaStamp
{
  ...
  struct alignas(onika::memory::DEFAULT_ALIGNMENT) ReboNconjOp
  {
...
{
  template<class NijcFieldT, class NijhFieldT, class NconjFieldT>
  struct ComputePairTraits< exaStamp::ReboNconjOp<NijcFieldT, NijhFieldT, NconjFieldT> >
  {

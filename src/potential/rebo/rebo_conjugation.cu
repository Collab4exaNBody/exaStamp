...
namespace exaStamp
{
  ...
  template<
    ...
    >
  class ReboConjugation : public OperatorNode
  {
    ...
    using ComputeBufferReboNconj     = ComputePairBuffer2<false,false,ReboNconjOpExtStorage>;
  ...
  public:
    ...
    inline void execute() override final
    {
      ...
      auto compute_buf_nconj = make_compute_pair_buffer<ComputeBufferReboNconj>();
  ...
  template<class GridT> using ReboConjugationTmpl = ReboConjugation<GridT>;

  ONIKA_AUTORUN_INIT(rebo_conjugation)
  {
    OperatorNodeFactory::instance()->register_factory(
        "rebo_conjugation", make_grid_variant_operator<ReboConjugationTmpl>);
  }

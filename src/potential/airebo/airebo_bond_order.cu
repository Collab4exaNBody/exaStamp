...
#include "airebo_bond_order_op.h"
...
namespace exaStamp
{
  ...
  template<
    ...
    >
  class AireboBondOrder : public OperatorNode
  {
  ...
  template<class GridT> using AireboBondOrderTmpl = AireboBondOrder<GridT>;

  ONIKA_AUTORUN_INIT(airebo_bond_order)
  {
    OperatorNodeFactory::instance()->register_factory(
        "airebo_bond_order", make_grid_variant_operator<AireboBondOrderTmpl>);
  }

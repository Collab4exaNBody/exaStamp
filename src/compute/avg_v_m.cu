...
namespace exaStamp {
  ...
  struct ReduceParticleVelMassFunctor {
    ...
    ONIKA_HOST_DEVICE_FUNC inline void operator()(ParticleVelMassValue& local, const double vx, const double vy, const double vz, const size_t type, reduce_thread_local_t = {}) const {
      Vec3d v = {vx, vy, vz};
      
      double mass = m_type_mass[ type ];
...
namespace exanb
{
  ...
  template <>
  struct ReduceCellParticlesTraits< exaStamp::ReduceParticleVelMassFunctor >
  {
...
namespace exaStamp {
  ...
  {
    using ReduceFields = FieldSet<field::_vx, field::_vy, field::_vz, field::_type>;
  ...
  public:
    inline void execute() final {
      ...
      ReduceParticleVelMassFunctor func = { particle_type_properties->scalar_property("mass") };
